//**********************************************************************
//**                                                                  **
//**        (C)Copyright ASUSTEK Hunter_Chen   2008-08                **
//**                                                                  **
//**              All Rights Reserved.                                **
//**                                                                  **
//**********************************************************************
...
int main()
{
	printf("AllotMEM.cpp int main()\n");
	CAllotMem allot("AllotMEM.cpp");
//	allot.token("\n\r");
//	allot.token();
	CGet get;

	for(char *cp=allot.allot.start;cp<allot.allot.end;){
		cp=get.getLine(cp,allot.allot.end);
		printf("line=%d:%s\n",get.line,get.buf);
	}
	return 0;
}
